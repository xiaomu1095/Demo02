...
import com.example.ll.demo02.okhttp.builder.GetBuilder;
import com.example.ll.demo02.okhttp.builder.HeadBuilder;
import com.example.ll.demo02.okhttp.builder.OtherRequestBuilder;
import com.example.ll.demo02.okhttp.builder.PostFileBuilder;
import com.example.ll.demo02.okhttp.builder.PostFormBuilder;
import com.example.ll.demo02.okhttp.builder.PostStringBuilder;
import com.example.ll.demo02.okhttp.callback.Callback;
import com.example.ll.demo02.okhttp.cookie.CookieJarImpl;
import com.example.ll.demo02.okhttp.cookie.store.CookieStore;
import com.example.ll.demo02.okhttp.cookie.store.HasCookieStore;
import com.example.ll.demo02.okhttp.cookie.store.MemoryCookieStore;
import com.example.ll.demo02.okhttp.https.HttpsUtils;
import com.example.ll.demo02.okhttp.log.LoggerInterceptor;
import com.example.ll.demo02.okhttp.request.RequestCall;
import com.example.ll.demo02.okhttp.utils.Exceptions;
    ...
    public static OkHttpUtils getInstance()
    {
        ...
        if (okHttpUtilsTmp == null)
        {
            synchronized (OkHttpUtils.class)
            {
                ...
                if (okHttpUtilsTmp == null)
                {
                    mInstance = okHttpUtilsTmp = new OkHttpUtils(null);
                }
            }
        }
